...
namespace WinAMBurner
{
    ...
    class Gui
    {
        ...
        //public async Task<JsonDocument> add<TJson, T>(Web web, TJson jentity, T entity, string url)
        //{
        //    JsonDocument jsonDocument = await web.entityAdd(jentity, url);
        //    if (jsonDocument != null)
        //    {
        //        T rentity = Type;
