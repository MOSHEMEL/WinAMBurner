...
namespace WinAMBurner
{
    public partial class FormMain : Form
    {
        ...
        private void screenLoginShow()
        {
            ...
            button1 = Gui.draw(this, typeof(Button), text: "Login", eventHandler: new EventHandler(buttonLogin_Click), placev: Gui.Place.End) as Button;
        ...
        private void screenActionShow()
        {
            ...
            Gui.draw(this, typeof(Button), text: "Update AM", eventHandler: new System.EventHandler(buttonUpdateAM_Click), placev: Gui.Place.Five);
            //Gui.buttonDraw(this, ref button2, "Manage Farms", new System.EventHandler(buttonFarm_Click), placev: Gui.Place.Five);
            Gui.draw(this, typeof(Button), text: "Manage Farms", eventHandler: new System.EventHandler(buttonFarm_Click), placev: Gui.Place.Six);
            //Gui.buttonDraw(this, ref button3, "Manage Service provider", new System.EventHandler(buttonService_Click), placev: Gui.Place.Six);
            Gui.draw(this, typeof(Button), text: "Manage Service provider", eventHandler: new System.EventHandler(buttonService_Click), placev: Gui.Place.Seven);
        ...
        private async Task FarmTableGet()
        {
            ...
            if (farms != null)
            {
                ...
                foreach (var f in farms.Select(f => rowAdd(f)))
                    farmTable.Rows.Add(f.ToArray<string>());
            }
        }

        private List<string> rowAdd(Farm f)
        {
            return new List<string> { f.Name.val, f.Country.val + " / " + f.State.val, f.City.val, f.Address.val };
        }
        ...
        private void screenConnectShow()
        {
            ...
            label3 = Gui.draw(this, typeof(Label), text: "", placev: Gui.Place.Six) as Label;
        ...
        private void AMDisconnectedShow()
        {
            ...
            label3 = Gui.draw(this, typeof(Label), text: "AM not found – make sure AM is connected using USB cable", color: Color.Red,
        ...
        private void AMConnectedShow()
        {
            ...
            label3 = Gui.draw(this, typeof(Label), text: "AM found – connected to AM", color: Color.Green,
                placeh: Gui.Place.Center, placev: Gui.Place.Six) as Label;
        ...
        private void screenTreatShow()
        {
            ...
            Gui.draw(this, typeof(ComboBox), text: web.partNumbers[0], items: web.partNumbers, placev: Gui.Place.Seven);
            progressBar1 = Gui.draw(this, typeof(ProgressBar), placev: Gui.Place.Eight) as ProgressBar;
        ...
        private void screenFarmAddShow()
        {
            ...
            screenFarmUpdateShow(farm, false);
        ...
        {
            screenFarmUpdateShow(farm, true);
        ...
        private async void buttonFarmAddSubmit_Click(object sender, EventArgs e)
        {
            ...
            if(responseParse<FarmJson>(farmResponse) == ErrCode.OK)
            {
                ...
                farmTable.Rows.Add((new List<string>() { rowAdd(farm) }).ToArray<string>());
